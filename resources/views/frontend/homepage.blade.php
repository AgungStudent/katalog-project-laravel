        ...
        <div class="container">
          <div class="row flex-center">
            ...
            <div class="col-md-5 text-center text-md-start">
              ...
              <a class="btn btn-primary rounded-pill px-3" href="about"
                >Tentang Kami</a
              >
            </div>
          </div>
      ...
      <div class="py-5" id="visi-misi">
        <div class="container">
          <div class="mx-4 row text-sm-start">
            <div
              class="col-md-5 shadow-transition order-md-0 text-center text-md-start pt-3"
            >
            ...
            <div class="col-md-1"><hr class="hr-line" /></div>
            <div
              class="col-md-6 shadow-transition text-center text-md-start pt-3"
            >
        ...
        <div class="container">
          <div class="row flex-center">
            <div class="col-md-5 order-md-0 text-center text-md-start">
              <img
                class="img-fluid mb-4"
                src="assets/img/illustrations/printing2.jpg"
                width="450"
                alt=""
              />
            </div>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-9 col-lg-6 text-center mb-3">
              ...
              <h5 class="fw-light">
                <a class="text-info" href="finishing-machine"
            ...
            <div class="col-sm-6 col-lg-4 pb-lg-6 px-lg-4 pb-4">
              <div class="card py-3 shadow-sm h-100">
                <div class="text-center">
                  <a href="detail/1"
                    ><img
                      class="image-zoom rounded"
                      src="https://mdbcdn.b-cdn.net/img/Photos/Horizontal/E-commerce/Products/belt.webp"
                      width="90%"
                      alt=""
                  /></a>
                  <div class="card-body px-2">
                    <h6 class="fw-bold fs-1 heading-color">title</h6>
                    <p class="mb-0 card-text text-left">
                      Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                      Sequi, nam fugit. Magni in corrupti quos ut esse dicta
                      fugiat rerum nobis, sed vitae consequatur nisi sapiente
                      rem officia tenetur minima?
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div class="container" id="product">
          <div class="row justify-content-center">
            <div class="col-md-9 col-lg-6 text-center mb-3">
              ...
              <h5 class="fw-light">
                <a class="text-info" href="products"
                  >Lihat semua <i class="fas fa-arrow-right"></i>
                </a>
              </h5>
            </div>
                  ...
                  <div class="card py-3 shadow-sm h-100 hover-top">
                    <div class="text-center">
                      ...
                      <div class="card-body px-2">
                        ...
                        <p class="mb-0 card-text text-left">{{ str(strip_tags($product->specifications))->limit(50) }}</p>
                        <div class="mt-3">
                          <a
                            class="text-center p-2 d-block btn btn-outline-primary"
...
<div class="container text-center my-5" id="client">
          ...
          <div
            class="row mx-auto justify-content-center my-5"
            style="background-color: rgb(255, 255, 255)"
          >
            <div class="col-6 col-md-2">
              <img src="assets/img/mitra/mitra0.jpg" width="100" alt="" />
            </div>
            <div class="col-6 col-md-2">
              <img src="assets/img/mitra/mitra1.jpg" width="100" alt="" />
            </div>
            <div class="col-6 col-md-2">
              <img src="assets/img/mitra/mitra2.jpg" width="100" alt="" />
            </div>
            <div class="col-6 col-md-2">
              <img src="assets/img/mitra/mitra3.jpg" width="100" alt="" />
            </div>
            <div class="col-6 col-md-2">
              <img src="assets/img/mitra/mitra4.jpg" width="100" alt="" />
            </div>
            <div class="col-6 col-md-2">
              <img src="assets/img/mitra/mitra5.jpg" width="100" alt="" />
            </div>
            <div class="col-6 col-md-2">
              <img src="assets/img/mitra/mitra6.jpg" width="100" alt="" />
            </div>
            <div class="col-6 col-md-2">
              <img src="assets/img/mitra/mitra7.jpg" width="100" alt="" />
            </div>
            <div class="col-6 col-md-2">
              <img src="assets/img/mitra/mitra8.jpg" width="100" alt="" />
            </div>
            <div class="col-6 col-md-2">
              <img src="assets/img/mitra/mitra9.jpg" width="100" alt="" />
            </div>
            <div class="col-6 col-md-2">
              <img src="assets/img/mitra/mitra10.jpg" width="100" alt="" />
            </div>
          </div>
          <a class="text-info" href="clients"
            >Lihat semua <i class="fas fa-arrow-right"></i>
          </a>
        </div>
        <!-- END KLIEN -->
