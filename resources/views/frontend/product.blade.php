...
<div
    ...
    <div>
        ...
        <div class="container" id="product"
            style="padding-top: 10vh; background-image: url({{asset('assets/img/illustrations/category-bg.png')}}); background-position: right center; background-repeat: no-repeat;">
